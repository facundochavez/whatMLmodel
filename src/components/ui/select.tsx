...
const SelectContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { noPortal?: boolean }
>(({ className, children, position = "popper", noPortal, ...props }, ref) => {
  const content = (
  ...
  return noPortal ? content : <SelectPrimitive.Portal>{content}</SelectPrimitive.Portal>;
});
